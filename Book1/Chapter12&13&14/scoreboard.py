...
class Scoreboard:
    ...
    def prep_time(self, elapsed_time):
        """Turn the elapsed time into a rendered image."""
    ...
    def check_high_score(self):
        ...
        if self.stats.score > self.stats.high_score:
            ...
            self.stats.save_high_score(self.stats.high_score)  # Save to file
            self.prep_high_score()
